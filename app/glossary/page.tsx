...
export default function GlossaryPage() {
  ...
  const handleLeadSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "We'll be in touch with you soon to help with your business planning needs.",
    })
      ...
      <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 animate-fade-in-up">
            ...
            >
              Need help applying these terms? Try Plan Builder
          ...
          <DialogHeader>
            <div className="flex items-center justify-between">
              <DialogTitle className="text-2xl font-bold text-gray-900">
                Get Personalized Help from PlanInsta
              </DialogTitle>
              <Button variant="ghost" size="icon" onClick={() => setShowLeadModal(false)} className="rounded-2xl">
                <X className="h-4 w-4" />
              </Button>
            </div>
            <p className="text-gray-600 mt-2">Let us help you build smarter by tailoring to your needs.</p>
          </DialogHeader>
          <form onSubmit={handleLeadSubmit} className="space-y-4 mt-6">
