...
export default function PlanBuilderPage() {
  ...
  const handleGeneratePlan = async () => {
    ...
    // Simulate AI generation for 10 seconds
    await new Promise((resolve) => setTimeout(resolve, 10000))

    // Generate the plan content
    const plan: GeneratedPlan = {
      executiveSummary: generateExecutiveSummary(planData),
      marketAnalysis: generateMarketAnalysis(planData),
      productStrategy: generateProductStrategy(planData),
      marketingStrategy: generateMarketingStrategy(planData),
      operationsStrategy: generateOperationsStrategy(planData),
      financialProjections: generateFinancialProjections(planData),
      milestonesAndTraction: generateMilestonesAndTraction(planData),
      additionalNotes: planData.notes || "No additional notes provided.",
    }
...
// Helper functions to generate plan content
